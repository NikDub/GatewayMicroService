...
public interface IHttpService
{
    ...
    Task<Guid> HttpCreateAsync<TF>(string url, TF content, string attributeFromHeader);
    Task HttpPutAsync<TF>(string url, Guid id, TF content, string attributeFromHeader);
    Task<string> HttpGetStringByIdAsync(string url, Guid id, string attributeFromHeader);
}